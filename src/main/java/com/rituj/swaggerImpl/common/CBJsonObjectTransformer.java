...
import com.rituj.swaggerImpl.exception.InvalidDataException;

/**
 * This class holds transformation logic between a given domain/model object and {@link JsonDocument}.
 *
 * @author rituj
 */
@Component
public class CBJsonObjectTransformer {
     ...
     */
    public <T> List<JsonObject> toJsonObjects(final List<T> objects) {
     ...
     * @throws IllegalArgumentException if the given data is invalid
     */
    public <T> JsonObject toJsonObject(final T object) {
        ...
        try {
            ...
            throw new InvalidDataException("Failed to serialize json document for id ", e);
        }
    }
}
